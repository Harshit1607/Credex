...
const Reviews:React.FC = () => {
  return (
    <div  className="w-[100vw] h-[45dvh] flex flex-col justify-between gap-10 items-center">
      <div className="w-[90%] h-[20%] flex justify-start items-center text-[5vw] font-bold">Customer Testimonials</div>
      <div className='flex w-[90%] h-[60%] justify-around items-start'>
        <div className='w-[45%] rounded-3xl h-[90%] bg-white flex flex-col justify-center gap-5'>
          <div className='flex justify-between items-center w-full px-5 h-[30%]'>
            <div className='flex flex-col justify-around items-start h-full text-black'>
              <span className='text-[1.4vw] font-semibold'>Sarah Lane</span>
          ...
          <div className='flex items-start w-full px-5 h-[50%] text-black'>
        ...
        <div className='w-[45%] rounded-3xl h-[90%] bg-white flex flex-col justify-center gap-5'>
          <div className='flex justify-between items-center w-full px-5 h-[30%]'>
            <div className='flex flex-col justify-around items-start h-full text-black'>
              <span className='text-[1.4vw] font-semibold'>David Kim</span>
